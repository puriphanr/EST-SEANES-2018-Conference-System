                                    ...
                                    <div class="card-body card-block">
										<div class="row">
											...
											<div class="statistic__item" style="height:100%">
												<h2 class="number p-b-20" style="color:#ef4b2f">{page_subtitle}</h2>
												<span class="desc p-b-20 normalcase">{page_message}</span>
												<div class="m-t-20">
															<a href="#" onclick="window.history.back()" class="btn btn-danger btn-lg">Back</a>
												</div>
												<div class="icon">
													<i class="zmdi zmdi-alert-triangle" style="font-size:300px"></i>
												</div>
											</div>
											</div>
