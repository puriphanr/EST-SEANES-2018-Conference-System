                         ...
                         <div class="card-body">
								...
								<div class="invoice-template">
									...
									<div class="form-actions form-group text-center p-t-20 m-b-20">
															...
															<a style="display:inline-block;margin-right:10px;" target="_blank" href="<?php echo site_url('registration/downloadInvoice/'.$data['reg_id'])?>" class="btn btn-danger btn-lg">Save PDF</a>
															<?php if($data['payment_type'] == 2){ ?>
															<div style="display:inline-block">
															<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="UFLQYTCYXU69N">
<input type="image" src="https://www.paypalobjects.com/en_GB/TH/i/btn/btn_paynowCC_LG.gif" border="0" name="submit" alt="PayPal – The safer, easier way to pay online!">
