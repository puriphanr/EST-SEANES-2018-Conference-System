...
<br><div class="body-text" style="font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; text-align: left; color: black;" align="left">
 <p style="font-weight:bold">The manuscript ID: <?php echo $paper['paper_code'] ?></p>
 <p style="font-weight:bold">Entitled: <?php echo $paper['title'] ?></p>
 <p>Have been completely evaluated by the reviewer named "<?php echo $reviewer['firstname']?> <?php echo  $reviewer['middlename']?> <?php echo  $reviewer['lastname']?>"</p>
 <br>
 <p> <a href="<?php echo site_url('admin')?>" target="_blank">Click here</a> to login and check the comment of the reviewer.</p>
<br>
