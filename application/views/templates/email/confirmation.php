...
<?php $link = site_url('account/confirmation').'/'.$token; ?>
...
<br><div class="body-text" style="font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; text-align: left; color: black;" align="left">
 ...
 <p>You receive this email because you have registered as a member of The 5th International Conference of Southeast Asian Network of Ergonomics Societies (SEANES 2018). To verify this email address and complete your registration please click <a href="<?php echo $link?>" target="_blank">here</a> </p>
 ...
 <p>If you didn't submit any registration for SEANES 2018 account please ignore this mail and we apologize for the inconvenience.</p>
