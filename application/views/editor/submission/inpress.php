						...
						<div class="col-md-12">
                            ...
                            <div class="card-body">
								...
								<div class="p-b-30">
									...
									<form action="<?php echo site_url('editorSubmission/saveInpress')?>" method="post" id="inpressForm" enctype="multipart/form-data">
															  ...
															  <div class="card-body">
																<div class="row">
																	...
																	<div class="col-md-8">
																		...
																		<div>
																		<a target="_blank" href="<?php echo  site_url("editorSubmission/forceDownload/".$paper['paper_id']."/inpress_file_pdf/INPRESS")?>" class="card-link">Download</a>
															  ...
															  <div class="card-body">
																<div class="row">
																	...
																	<div class="col-md-8">
																		...
																		<div>
																		<a target="_blank" href="<?php echo  site_url("editorSubmission/forceDownload/".$paper['paper_id']."/inpress_file_word/INPRESS")?>" class="card-link">Download</a>
